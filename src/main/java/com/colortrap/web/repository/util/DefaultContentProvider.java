...
public class DefaultContentProvider {
    ...
    public String getWorkshopDescription(String title, String eventType, int numberOrParagraph) {
        ...
        String description4 = "Ще се насладите на приятна атмосфера, релакс и чаша вино или друга напитка.\n";
        ...
        if (eventType.equals("Творческа лаборатория")){
            ...
            description4 = "Ще се насладите на приятна атмосфера, усмивки и чаша сок или друга напитка.\n";
            description5 = "Резервирайте своето място сега и подарете на детето си цветно приключение, изпълнено с различни техники и материали.";
    ...
    public String getPrivateEventDescription(String title, int numberOrParagraph) {
        ...
        if(title.startsWith("Работилница с")){
            ...
            description4 = "Резервирайте за желаната от вас дата поне 7 дни предварително, а ние ще се свържем с вас за допълнителна информация и потвърждаване на резервацията.";
            ...
            description1 = "Залата е 100 квадрата, разположени на две нива, с работилница до 25 седящи места, просторна и светла, осигурявайки комфорт и безпроблемно протичане на вашето събитие.";
            ...
            description3 = "Резервирайте за желаната от вас дата поне 7 дни предварително, а ние ще се свържем с вас за допълнителна информация и потвърждаване на резервацията.";
            description4 = "";
        }
