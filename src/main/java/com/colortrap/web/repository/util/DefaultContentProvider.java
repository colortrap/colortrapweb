...
public class DefaultContentProvider {
    ...
    public String getWorkshopDescription(String title, String eventType, int numberOrParagraph) {
        ...
        String description4 = "По време на събитието ще се насладите на приятна атмосфера, релакс и чаша вино или друга напитка.\n";
        String description5 = "Резервирайте своето място сега и си подарете една творческа, спокойна и вдъхновяваща вечер.\n";
        ...
        if (eventType.equals("Галантерия") || eventType.equals("Галантерия и вино")){
            ...
            description2 = "Нашият водещ ще ви напътства стъпка по стъпка как да ушиете своя уникален кожен ключодържаател, който да отнесете с гордост у дома или да подарите на любим човек.\n";
        ...
        if (eventType.equals("Плюшена тел") || eventType.equals("Плюшена тел и вино")){
            if(title.startsWith("Рисуване с")){
                ...
                description1 = "Всеки участник ще получи всички необходими материали и инструменти на място и единствено е нужно да дойдете с добро настроение и желание за творчество.";
                description2 = "Нашият водещ ще ви напътства стъпка по стъпка как да създадете своето уникалено вторение от плюшена тел, което да отнесете с гордост у дома или да подарите на любим човек.";
                description4 = "По време на събитието ще се насладите на приятна атмосфера, усмивки и чаша сок или друга напитка.\n";
            } else {
        ...
        if (eventType.equals("Полимерна глина") || eventType.equals("Полимерна глина и вино")){
            if(title.startsWith("Рисуване с")){
                ...
                description1 = "Всеки участник ще получи всички необходими материали и инструменти на място и единствено е нужно да дойдете с добро настроение и желание за творчество.";
                description2 = "Нашият водещ ще ви напътства стъпка по стъпка как да създадете своеята уникалена картина от полимерна глина, която да отнесете с гордост у дома или да подарите на любим човек.";
                description4 = "По време на събитието ще се насладите на приятна атмосфера, усмивки и чаша сок или друга напитка.\n";

            } else {
            description = "Colortrap ви кани да сътворим заедно от полимерна глина.";
            description1 = "Всеки участник ще получи всички необходими материали и инструменти на място и единствено е нужно да дойдете с добро настроение и желание за творчество.";
            description2 = "Нашият водещ ще ви напътства стъпка по стъпка как да създадете своето уникалено торение от полимерна глина, което да отнесете с гордост у дома или да подарите на любим човек.";
        ...
        if (eventType.equals("Интуитивно рисуване и вино")){
            ...
            description2 = "Нашият водещ ще ви въведе в процеса и ще ви напътства, но творбата ще бъде изцяло ваше лично вдъхновение. Ще имате свободата да експериментирате, да играете с цветовете и да създадете свой уникален проект, който да отнесете у дома с гордост.\n";
    ...
    public String getPrivateEventDescription(String title, int numberOrParagraph) {
        ...
        if(title.startsWith("Работилница с")){
            ...
            description2 = "Просторна, светла и оборудвана с необходимата техника, залата осигурява комфорт и безпроблемно протичане на празника.";
            description3 = "По желание можем да предложим и кетъринг, за да добавим изискано обслужване и допълнително удобство за вас и вашите гости.";
            description4 = "Резервирайте за желаната от вас дата поне 7 дни предварително, а ние ще се свържем с вас за допълнително информация и потвърждаване на резервацията.";
        } else if(title.startsWith("Наем на зала")){
            ...
            description1 = "Залата е 100 квадрата, разположени на две нива, с работилница до 25 седящи места, е просторна и светла, осигурявайки комфорт и безпроблемно протичане на вашето събитие.";
            description2 = "По желание можем да предложим и кетъринг, за да добавим изискано обслужване и допълнително удобство за вас и вашите гости.";
            description3 = "Резервирайте за желаната от вас дата поне 7 дни предварително, а ние ще се свържем с вас за допълнително информация и потвърждаване на резервацията.";
        }
